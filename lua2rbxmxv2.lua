...
env.Instance = {
	new = function(classname)
		...
		if classname == "KeyframeMarker" then
			local x = {
				Name = "KeyframeMarker",
...
local function serialize(inst)
	...
	if inst.ClassName == "IntValue" then
	append("<int name=\"Value\">" .. inst.Value .. "</int>")
end
if inst.ClassName == "KeyframeMarker" then
	append("<string name=\"Value\">" .. inst.Value .. "</string>")
end
